      ...
      <ul class="release-list">
        ...
        >
          ...
          <div class="release-item-info">
            <span @click="openVersion(release_test.id)">{{ release_test.version }}</span>
...
export default {
  ...
  methods: {
    ...
    openVersion(testRequestId) {
      const {project_id} = this.$route.params;
      this.$router.push(`/project/${project_id}/testrequest/${testRequestId}`)
    }
  },
  created() {
